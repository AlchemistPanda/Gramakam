...
export const ALL_QUESTIONS: QuizQuestion[] = [
  ...
  {
    id: 'q6',
    question: 'What type of art form is the primary focus of Gramakam?',
    options: ['Dance', 'Theatre', 'Painting', 'Sculpture'],
    correctAnswer: 1,
  ...
  {
    id: 'q11',
    question: 'What month does Gramakam 2026 take place?',
